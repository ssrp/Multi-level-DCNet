"""
Some key layers used for constructing a the Capsule Network architecture, which helps to build a Multi-level DCNet.

Code credits to Xifeng Guo: `https://github.com/XifengGuo/CapsNet-Keras`

Updates specific to Multi-level DCNets:
